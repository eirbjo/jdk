...
import static sun.net.www.protocol.file.FileURLConnection.isNonLocalFileURL;
...
class JarFileFactory implements URLJarFile.URLJarFileCloseController {
    ...
    private URL urlFor(URL url) throws IOException {
        // Deal with Windows UNC pathnames specially. See 4180841
        if (OperatingSystem.isWindows() && isNonLocalFileURL(url)) {
            // Replace 'file://host/folder/data.xml' with 'file:////host/folder/data.xml'
            return new URL("file", "", "//" + url.getHost() + url.getPath());
        }
        return url;
    }
