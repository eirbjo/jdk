...
public record Cen(short version,
    ...
    static Cen read(long index, LEInput input) {
        ...
        return new Cen(version, extractVersion, flags, method, time, date, crc, csize, size, diskStart, internalAttr, externalAttr, locOff, name, extFields, comment);
    }
    ...
    void write(Zink.LEOutputStream out) throws IOException {
        ...
        out.writeShorts((short) name.length, elen(), (short) comment.length, diskStart, internalAttr);
    ...
    public Cen name(byte[] name) {
        return new Cen(version, extractVersion, flags, method, time, date, crc, csize, size, diskStart, internalAttr, externalAttr, locOff, name, extra, comment);
    }
    ...
    public Cen toZip64() {
        ...
        return new Cen(version, extractVersion, flags, method, time, date, crc, csize, size, dstart, internalAttr, externalAttr, locOff, name, extra, comment);
    }
